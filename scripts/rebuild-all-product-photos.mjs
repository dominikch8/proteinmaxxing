...
const FOOD_SUBJECT = {
    ...
    'milky-way': 'ONE single classic Milky Way chocolate candy bar unwrapped, exactly one bar only',
    mars: 'ONE classic Mars chocolate candy bar unwrapped, NO packaging',
    twix: 'Twix chocolate caramel cookie bars',
    snickers: 'classic Snickers chocolate peanut caramel nougat candy bar unwrapped',
    ...
    'kitkat-chunky': 'ONE KitKat Chunky thick single chocolate wafer stick bar unwrapped, NOT 4-finger KitKat',
    'snickers-white': 'ONE Snickers White candy bar white chocolate coated peanut caramel nougat unwrapped',
    ...
    'zupa-pho': 'Vietnamese pho noodle soup in white bowl, clear aromatic beef broth, flat rice noodles, fresh basil lime bean sprouts, pho bo style, NOT tripe, NOT flaki, NOT beef intestine strips',
    ...
    'lody-waniliowe': 'two scoops vanilla ice cream in white bowl, pale cream, NO chocolate sauce NO chocolate chips',
    'dzem-truskawkowy': 'strawberry jam in clear glass jar with blank label, classic jam jar, NO chocolate',
    'sernik-kawalek': 'triangular wedge slice of cheesecake with creamy white filling, NOT round whole cake',
    makowiec: 'typical round cross-section slice of Polish makowiec poppy seed roll cake',
    'czekolada-mleczna': 'solid rectangular milk chocolate bar broken squares, solid chocolate, NOT a drink NOT cocoa mug',
    'czekolada-100': 'solid rectangular 100 percent dark chocolate bar tablet, solid chocolate piece, NOT a drink',
    'krakersy-pelnoziarniste': 'plain whole grain crackers stack only, NO filling NO cream NO toppings between crackers',
    'galaretka-owocowa': 'plain translucent red fruit gelatin jelly dessert in bowl, galareta owocowa, NO chocolate coating',
    ...
    'makaron-udon': 'plain cooked thick Japanese udon noodles only in simple white bowl, no toppings no sauce no broth no vegetables no meat no chopsticks no bamboo mat',
    'mac-n-cheese-makaron-z-serem': 'classic American mac and cheese elbow macaroni in thick creamy cheddar cheese sauce in white bowl, no packaging',
